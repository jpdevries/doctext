		...
		concat: {
			...
			h5bp: {
				src: [
					...
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/rainbow.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/language/css.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/language/generic.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/language/html.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/language/javascript.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/language/php.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>vendor/rainbow/language/shell.js',
